...
RUN wget https://edgedl.me.gvt1.com/edgedl/chrome/chrome-for-testing/119.0.6045.105/linux64/chromedriver-linux64.zip -O /tmp/chromedriver_linux64.zip && \
    cd /tmp/ && unzip chromedriver_linux64.zip && \
    mv chromedriver-linux64/chromedriver /usr/bin/chromedriver && cd -
```
